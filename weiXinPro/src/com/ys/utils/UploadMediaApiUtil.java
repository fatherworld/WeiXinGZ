...
public class UploadMediaApiUtil {
    ...
    private static final String UPLOAD_VIDEO = "https://fili.weixin.qq.com/cgi-bin/media/upload";
    // 素材下载:不支持视频文件的下载(GET)
    ...
    public  JSONObject uploadMedia(File file, String token, String type) {
        ...
        PostMethod post = null;
        	...
        	{
        		post = new PostMethod(UPLOAD_VIDEO);
        	}
        	else{
             ...
             try {
                 ...
                 System.out.println("httpClient.executeMethod(post) start");
                 int status = httpClient.executeMethod(post);
                 System.out.println("httpClient.executeMethod(post) end");
