...
public class YouDaoAPI {
    public String translate(String q)throws Exception{
        //应用申请的key
        String appKey ="11d5b41c599b250d";
        //要翻译的文本 必须是UTF-8编码
        String query = q;
        //随机数
        ...
        String sign = md5(appKey + query + salt+"nKUD3tPKrAWjHHJfMAZ4EktZlUWInf3d");

        System.out.println("create parameter");
    ...
    public  String requestForHttp(String url,Map requestParams) throws Exception{
        ...
        try{
            ...
            System.out.println("dto" + dto.getL());
            
            System.out.println("dto" + dto.getQuery());
            
            System.out.println("dto" + dto.getErrorCode());
            ...
            if(!"".equals(dto.getBasic()) && dto.getBasic() != null){
                ...
                */
            	Explains basic = dto.getBasic();
            	sb.append("词义:");
            	List<String> ysExplains = basic.getExplains();
            	for(int i = 0;i< ysExplains.size();i++)
            	{
            		sb.append(ysExplains.get(i)+ "\n");
